...
public class PlaceOrderFormController implements Initializable {
    ...
    private void placeOrderPressed(ActionEvent event) {
        ...
        try {
            boolean result = placeOrderBO.placeOrder(ordersDTO, itemdetails);
            if(result){
                new Alert(Alert.AlertType.INFORMATION, "Order has been successfully added...", ButtonType.OK).show();
            }else{
